...
var leftRec = map[NT]NTs { 
	...
	NT_LexAlternates: NTs {  NT_LexBracket,  NT_RegExp,  NT_LexGroup,  NT_LexOptional,  NT_LexZeroOrMore,  NT_LexOneOrMore,  NT_UnicodeClass,  NT_LexSymbol,  },
	...
	NT_OrderedAlternates: NTs {  NT_SyntaxAlternate,  NT_SyntaxSymbols,  NT_SyntaxAtom,  NT_SyntaxSymbol,  NT_SynOptional,  },
	NT_Package: NTs {  },
	NT_RegExp: NTs {  NT_LexGroup,  NT_LexOptional,  NT_LexZeroOrMore,  NT_LexOneOrMore,  NT_UnicodeClass,  NT_LexSymbol,  NT_LexBracket,  },
	NT_Rule: NTs {  NT_LexRule,  NT_SyntaxRule,  },
	NT_Rules: NTs {  NT_Rule,  NT_LexRule,  NT_SyntaxRule,  },
	NT_SynOptional: NTs {  NT_SyntaxAtom,  },
	NT_SyntaxAlternate: NTs {  NT_SyntaxSymbols,  NT_SyntaxAtom,  NT_SyntaxSymbol,  NT_SynOptional,  },
	NT_SyntaxAlternates: NTs {  NT_SyntaxAlternate,  NT_SyntaxSymbols,  NT_SyntaxAtom,  NT_SyntaxSymbol,  NT_SynOptional,  },
	NT_SyntaxAtom: NTs {  },
	NT_SyntaxRule: NTs {  },
	NT_SyntaxSymbol: NTs {  NT_SynOptional,  NT_SyntaxAtom,  },
	NT_SyntaxSymbols: NTs {  NT_SyntaxSymbol,  NT_SynOptional,  NT_SyntaxAtom,  },
	NT_UnicodeClass: NTs {  },
	NT_UnorderedAlternates: NTs {  NT_SyntaxAlternate,  NT_SyntaxSymbols,  NT_SyntaxAtom,  NT_SyntaxSymbol,  NT_SynOptional,  },
}

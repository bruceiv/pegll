...
var leftRec = map[NT]NTs { 
	...
	NT_LexAlternates: NTs {  NT_LexOneOrMore,  NT_UnicodeClass,  NT_LexBracket,  NT_LexGroup,  NT_RegExp,  NT_LexOptional,  NT_LexSymbol,  NT_LexZeroOrMore,  },
	...
	NT_OrderedAlternates: NTs {  NT_SyntaxSuffix,  NT_SyntaxAtom,  NT_SyntaxSymbols,  NT_SyntaxSymbol,  NT_SyntaxAlternate,  },
	NT_Package: NTs {  },
	NT_RegExp: NTs {  NT_LexSymbol,  NT_LexZeroOrMore,  NT_LexOneOrMore,  NT_UnicodeClass,  NT_LexBracket,  NT_LexGroup,  NT_LexOptional,  },
	NT_Rule: NTs {  NT_LexRule,  NT_SyntaxRule,  },
	NT_Rules: NTs {  NT_Rule,  NT_LexRule,  NT_SyntaxRule,  },
	NT_SyntaxAlternate: NTs {  NT_SyntaxSymbols,  NT_SyntaxSymbol,  NT_SyntaxSuffix,  NT_SyntaxAtom,  },
	NT_SyntaxAlternates: NTs {  NT_SyntaxSuffix,  NT_SyntaxAtom,  NT_SyntaxAlternate,  NT_SyntaxSymbols,  NT_SyntaxSymbol,  },
	NT_SyntaxAtom: NTs {  },
	NT_SyntaxRule: NTs {  },
	NT_SyntaxSuffix: NTs {  NT_SyntaxAtom,  },
	NT_SyntaxSymbol: NTs {  NT_SyntaxSuffix,  NT_SyntaxAtom,  },
	NT_SyntaxSymbols: NTs {  NT_SyntaxSuffix,  NT_SyntaxAtom,  NT_SyntaxSymbol,  },
	NT_UnicodeClass: NTs {  },
	NT_UnorderedAlternates: NTs {  NT_SyntaxAlternate,  NT_SyntaxSymbols,  NT_SyntaxSymbol,  NT_SyntaxSuffix,  NT_SyntaxAtom,  },
}
